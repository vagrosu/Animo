...
export function MessageCard({
  ...
  return (
    <div className={"relative max-w-[60%]"}>
      ...
      <div
        className={`flex flex-col gap-2 ${isSentByUser ? "bg-blue-100" : "bg-zinc-200"} px-4 py-3.5 ${isSentByUser ? `rounded-l-2xl ${!isFirstFromGroup && "rounded-r-2xl"}` : `rounded-r-2xl ml-2`} ${!isFirstFromGroup && "rounded-l-2xl"} rounded-b-2xl`}
      >
