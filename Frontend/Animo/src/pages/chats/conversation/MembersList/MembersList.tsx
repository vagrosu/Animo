...
export default function MembersList({name, members, isGroupChat, toggleMembersList}: MembersListProps) {
  ...
  return (
    <div className={`${isFloating ? "absolute right-0 z-50" : "relative"} flex flex-col items-center py-20 px-5 bg-white min-w-[20rem] w-[24vw] max-w-[23rem] h-full border-l border-gray-200`}>
      {isFloating && (
        <div
